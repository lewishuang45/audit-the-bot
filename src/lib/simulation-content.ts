import type { IssueCategory, KnownIssue, MemoStatement } from "./types";
...
export const flawedMemoStatements: MemoStatement[] = [
  {
    id: "s1",
...
export const knownIssues: KnownIssue[] = [
  ...
  },
  {
    ...
    expectedFinding:
      "The survey threshold is below HKD 18, and competitor bottled teas are HKD 10-16.",
  },
  {
    id: "K6",
    statementId: "s5",
    category: "factual error",
    expectedFinding:
      "Friends/campus events are 47%; short-form social media is 36%.",
  },
  {
    id: "K7",
    statementId: "s5",
    ...
    expectedFinding:
      "The brief supports campus/event discovery more than broad influencer spending.",
  },
  {
    id: "K8",
    statementId: "s6",
  ...
  },
  {
    ...
    statementId: "s7",
    category: "ethical or tone risk",
    expectedFinding: "This is a guaranteed performance claim.",
  },
  {
    id: "K10",
    statementId: "s8",
  ...
  },
  {
    ...
    statementId: "s9",
    category: "unsupported claim",
    expectedFinding: "The brief does not justify guaranteed growth.",
  },
  {
    id: "K12",
    statementId: "s10",
